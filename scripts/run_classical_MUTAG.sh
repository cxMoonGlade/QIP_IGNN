#!/bin/bash
# ======================================================================
# Classical ablation with attention pooling on MUTAG
#
...
#
# Usage:
#   bash scripts/run_classical_MUTAG.sh
#   GPUS="0 1 2 3" SESSION=classical_MUTAG_attention \
#     CONDA_ENV=qenv2 bash scripts/run_classical_MUTAG.sh
# ======================================================================
set -euo pipefail
cd "$(dirname "$0")/.."
PROJECT_DIR=$(pwd)
...
TMP_TASK_FILE=$(mktemp /tmp/qignn_mutag_classical_attention_XXXX.txt)
...
export GPUS="${GPUS:-0}"
export SESSION="${SESSION:-classical_MUTAG_attention}"
