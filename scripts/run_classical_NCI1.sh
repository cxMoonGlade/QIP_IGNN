#!/bin/bash
# ======================================================================
# Classical ablation with attention pooling on NCI1
#
...
#
# Usage:
#   bash scripts/run_classical_NCI1.sh
#   GPUS="0 1 2 3" SESSION=classical_NCI1_attention \
#     CONDA_ENV=qenv2 bash scripts/run_classical_NCI1.sh
# ======================================================================
set -euo pipefail
cd "$(dirname "$0")/.."
PROJECT_DIR=$(pwd)
...
TMP_TASK_FILE=$(mktemp /tmp/qignn_NCI1_classical_attention_XXXX.txt)
...
export GPUS="${GPUS:-0}"
export SESSION="${SESSION:-classical_NCI1_attention}"
